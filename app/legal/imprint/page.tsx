...
export const metadata = buildMetadata({
  title: "Impressum",
  description:
    "Impressum — required legal information per German Telemediengesetz §5 TMG. Martina Rink - UG (haftungsbeschränkt), Karlsruhe.",
  path: "/legal/imprint",
});
        ...
        <div className="space-y-10 text-[16px] leading-[1.75] text-ink-soft">
          ...
          <section>
            ...
            <p>
              ...
              Umsatzsteuergesetz: [USt-IdNr — to confirm with client]
            </p>
          </section>
