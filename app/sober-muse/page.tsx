        ...
        <div className="container-content space-y-8 max-w-3xl mx-auto">
          ...
          <figure className="bg-rose p-10 md:p-14 max-w-3xl mx-auto">
            ...
            <figcaption className="mt-8 flex items-center gap-4">
              ...
              <div>
                <p className="text-[12px] uppercase tracking-[0.18em] text-ink font-medium font-[family-name:var(--font-body)]">
                  Canan Chandni Bauer
                </p>
                <p className="text-[11px] uppercase tracking-[0.14em] text-ink-quiet mt-0.5 font-[family-name:var(--font-body)]">
